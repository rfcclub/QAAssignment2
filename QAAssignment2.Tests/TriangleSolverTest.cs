...
namespace QAAssignment2.Tests
{
    ...
    public class TriangleSolverTest
    {
        ...
        {
            string result = TriangleSolver.Analyze(1, 3, 4);
        ...
        {
            string result = TriangleSolver.Analyze(3, 1, 0);
            Assert.AreEqual("invalid", result);
        }
        ...
        {
            string result = TriangleSolver.Analyze(4, 3, 3);
            Assert.AreEqual("isosceles", result);
        }
        ...
        {
            string result = TriangleSolver.Analyze(3, 4, 3);
            Assert.AreEqual("isosceles", result);
        }
